...
class J16_assetsDAO 
{
    ...
    private static $sqlBasicSelect = 'select
                                     ...
                                     ,title
                                     ,rules
                                     from joomlainternet.j16_assets ';
    ...
    public function selectCount( $where=null )
    {
        ...
        $sql = 'select count(id) as qtd from joomlainternet.j16_assets';
    ...
    //--------------------------------------------------------------------------------
    public function insert( J16_assetsVO $objVo )
    {
        ...
        $sql = 'insert into joomlainternet.j16_assets(
                                 parent_id
                                ,lft
                                ,rgt
                                ,level
    ...
    //--------------------------------------------------------------------------------
    public function update ( J16_assetsVO $objVo )
    {
        $values = array( $objVo->getParent_id()
                        ,$objVo->getLft()
                        ,$objVo->getRgt()
                        ...
                        ,$objVo->getRules()
                        ,$objVo->getId() );
        $sql = 'update joomlainternet.j16_assets set 
                                 parent_id = ?
                                ,lft = ?
                                ,rgt = ?
                                ,level = ?
    ...
    public function delete( $id )
    {
        FormDinHelper::validateIdIsNumeric($id,__METHOD__,__LINE__);
        $values = array($id);
        $sql = 'delete from joomlainternet.j16_assets where id = ?';
        $result = $this->tpdo->executeSql($sql, $values);
        return $result;
    }
    //--------------------------------------------------------------------------------
