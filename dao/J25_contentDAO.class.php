...
class J16_contentDAO 
{
    ...
    private static $sqlBasicSelect = 'select
                                     ...
                                     ,language
                                     ,xreference
                                     from joomlainternet.j16_content ';
    ...
    private function processWhereGridParameters( $whereGrid )
    {
        ...
        if ( is_array($whereGrid) ){
            ...
            $where = SqlHelper::getAtributeWhereGridParameters($where, $whereGrid, 'TITLE_ALIAS', SqlHelper::SQL_TYPE_TEXT_LIKE);
            ...
            $where = SqlHelper::getAtributeWhereGridParameters($where, $whereGrid, 'SECTIONID', SqlHelper::SQL_TYPE_NUMERIC);
            $where = SqlHelper::getAtributeWhereGridParameters($where, $whereGrid, 'MASK', SqlHelper::SQL_TYPE_NUMERIC);
            ...
            $where = SqlHelper::getAtributeWhereGridParameters($where, $whereGrid, 'PARENTID', SqlHelper::SQL_TYPE_NUMERIC);
    ...
    public function selectCount( $where=null )
    {
        ...
        $sql = 'select count(id) as qtd from joomlainternet.j16_content';
    ...
    //--------------------------------------------------------------------------------
    public function insert( J16_contentVO $objVo )
    {
        $values = array(  $objVo->getAsset_id() 
                        , $objVo->getTitle() 
                        , $objVo->getAlias() 
                        , $objVo->getTitle_alias() 
                        , $objVo->getIntrotext() 
                        , $objVo->getFulltext() 
                        , $objVo->getState() 
                        , $objVo->getSectionid() 
        ...
        $sql = 'insert into joomlainternet.j16_content(
                                 asset_id
                                ,title
                                ,alias
                                ,title_alias
    ...
    //--------------------------------------------------------------------------------
    public function update ( J16_contentVO $objVo )
    {
        $values = array( $objVo->getAsset_id()
                        ,$objVo->getTitle()
                        ,$objVo->getAlias()
                        ...
                        ,$objVo->getXreference()
                        ,$objVo->getId() );
        $sql = 'update joomlainternet.j16_content set 
                                 asset_id = ?
                                ,title = ?
                                ,alias = ?
                                ,title_alias = ?
    ...
    public function delete( $id )
    {
        FormDinHelper::validateIdIsNumeric($id,__METHOD__,__LINE__);
        $values = array($id);
        $sql = 'delete from joomlainternet.j16_content where id = ?';
        $result = $this->tpdo->executeSql($sql, $values);
        return $result;
    }
    //--------------------------------------------------------------------------------
