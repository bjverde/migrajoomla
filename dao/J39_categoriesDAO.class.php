...
class J36_categoriesDAO 
{
    ...
    public function selectCount( $where=null )
    {
        ...
        $sql = 'select count(id) as qtd from portal.j36_categories';
    ...
    //--------------------------------------------------------------------------------
    public function insert( J36_categoriesVO $objVo )
    {
        ...
        $sql = 'insert into portal.j36_categories(
                                 asset_id
                                ,parent_id
                                ,lft
                                ,rgt
    ...
    //--------------------------------------------------------------------------------
    public function update ( J36_categoriesVO $objVo )
    {
        $values = array( $objVo->getAsset_id()
                        ,$objVo->getParent_id()
                        ,$objVo->getLft()
                        ...
                        ,$objVo->getVersion()
                        ,$objVo->getId() );
        $sql = 'update portal.j36_categories set 
                                 asset_id = ?
                                ,parent_id = ?
                                ,lft = ?
                                ,rgt = ?
    ...
    public function delete( $id )
    {
        FormDinHelper::validateIdIsNumeric($id,__METHOD__,__LINE__);
        $values = array($id);
        $sql = 'delete from portal.j36_categories where id = ?';
        $result = $this->tpdo->executeSql($sql, $values);
        return $result;
    }
    //--------------------------------------------------------------------------------
